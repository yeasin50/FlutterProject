                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.wb_sunny_sharp,
                                size: 15, color: Color(0xff8276f4)),
                    ...
                    child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(
                              '"Non è mai troppo tardi per diventare la persona che vuoi davvero essere"',
                              style: TextStyle(
...
class CategoryCard extends StatelessWidget {
  ...
  const CategoryCard({
    Key? key,
    required this.numeroicona,
    required this.title,
    required this.numerocolore,
  }) : super(key: key);
